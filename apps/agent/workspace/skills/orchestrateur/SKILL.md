...
```json
{
  ...
  "etape": "demarrage",
  "statut": "en_cours",
  "message": "Cycle de veille démarré"
}
```
...
```json
{
  ...
  "etape": "evaluation",
  "statut": "complete",
  "message": "Sources évaluées CRAAP"
}
```
...
```json
{
  ...
  "etape": "pestel",
  "statut": "complete",
  "message": "Analyse PESTEL terminée"
}
```
...
{
  "rapportId": "[rapportId]",
  "etape": "signaux_faibles",
  "statut": "complete",
  "message": "Signaux faibles identifiés"
}
```
